...
public class ObjectUtil {
	...
	public static <T> boolean isEquals(T... objects) {
        ...
        for(int i=1;i<objects.length;i++) {
        	T objecti=objects[i];
        	if(object0==null&&objecti==null)continue;
        	else if(objecti!=null&&!objecti.equals(object0)) return false;
        }
	...
	public static void attr(Object obj,String field,Object value) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
		String setterName="set"+StringUtil.firstCharToUpperCase(field);
 ...
 public static <T>  T attr(Object obj,String field) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
 	String getterName="get"+StringUtil.firstCharToUpperCase(field);
 	T t=null;
		...
		for(Field targetField : targetFields) {
		    ...
		    try {
		    	...
		    	if(sourceAnnFieldStruts.containsKey(targetField.getName())) {
				   ...
				   String sourceMethodName="get"+StringUtil.firstCharToUpperCase(targetField.getName());	
				...
				//if(DCMFactory.isDebug) {
					System.out.println("can't find target filed:"+target.getClass().getName()+"."+targetField.getName());
				//}
				continue;
			}
		    copy_count++;
 ...
 public static class CopyFieldStruct{
    ...
    public static  Map<String,CopyFieldStruct> getCopyFieldStructs(Object source){
